...
SELECT
  asl.starting_slot, -- Use the alias 'asl' for clarity and to avoid ambiguity
  asl.avg_slot_delta, -- Disambiguate by using the alias 'asl'
  asl.land_rate -- Disambiguate by using the alias 'asl'
FROM
  aggregated_stats asl -- Assign an alias 'asl' to the aggregated_stats CTE for clarity
ORDER BY
