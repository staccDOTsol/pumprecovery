...
pub mod tests {
    ...
    fn set_parameters_instruction(
        ...
        let accounts = vec![
            ...
            solana_sdk::instruction::AccountMeta::new_readonly(
                Pubkey::from_str("2fGvJ2r8rCpWv8s5bzPz2dwqnYG7bXnLQ1H6BEsL4kkH").unwrap(),
                false,
            ),
    ...
    fn create_amm_instruction(
        ...
        solana_sdk::instruction::Instruction {
            ...
            accounts: vec![
                solana_sdk::instruction::AccountMeta::new(*amm_pubkey, false),
                solana_sdk::instruction::AccountMeta::new_readonly(*global_parameters, false),
                solana_sdk::instruction::AccountMeta::new(*payer_pubkey, true),
                solana_sdk::instruction::AccountMeta::new_readonly(
                    solana_program::system_program::ID,
                    false,
    ...
    pub async fn setup_amm(
        ...
        if !global_parameters_account_info_maybe.is_ok() {
            ...
            let ixxs = vec![initialize_instruction, set_parameters_instruction];
            let mut transaction = Transaction::new_with_payer(&ixxs, Some(&payer.pubkey()));
